...
\title{A Hybrid Cryptographic Cross-Domain Authentication and Rogue UAV Interception Scheme for Low-Altitude Airspace}

\author{Anhui Normal University,~\IEEEmembership{LI Xiang,~NoIEEE,}
        % <-this % stops a space
